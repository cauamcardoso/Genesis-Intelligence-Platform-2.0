...
async function renderOverview(container) {
  ...
  html += `<div class="card hero-card" data-reveal="up">
    ...
    <h2 class="hero-heading">A smarter way to build<br>Genesis proposal teams.</h2>
    <p class="hero-desc">This platform scores ${S.totalFaculty} UTEP faculty against ${S.totalFocusAreas} DOE Genesis focus areas to help assemble the strongest possible research teams for each proposal. Instead of relying on existing networks, it uses a multi-axis scoring system to surface the researchers whose work, partnerships, and competitive advantages genuinely fit the call.</p>
  </div>`;
